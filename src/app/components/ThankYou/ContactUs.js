  ...
  return (
    <Paper sx={{ backgroundColor: theme.palette.background.light, padding: 4, boxShadow: 3 }}>
      ...
      <Box sx={{ mt: 3, textAlign: "center" }}>
        ...
        <IconButton href="#" sx={{ bgcolor: theme.palette.background.dark , padding: 2, color: theme.palette.secondary.main, '&:hover': { bgcolor: theme.palette.secondary.main, color: theme.palette.background.dark } }}>
          <LinkedIn />
        </IconButton>
      </Box>
    </Paper>
